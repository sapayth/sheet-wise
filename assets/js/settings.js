...
function useContextSystemBridge({
  ...
  use_update_effect(() => {
    ...
    valueRef.current !== value) {
      typeof SCRIPT_DEBUG !== "undefined" && SCRIPT_DEBUG === true ? warning(`Please memoize your context: ${JSON.stringify(value)}`) : void 0;
    }
  }, [value]);
 ...
 */
const constants_CONNECT_STATIC_NAMESPACE = '__contextSystemKey__';
...
function _contextConnect(Component, namespace, options) {
  ...
  if (typeof namespace === 'undefined') {
    typeof SCRIPT_DEBUG !== "undefined" && SCRIPT_DEBUG === true ? warning('contextConnect: Please provide a namespace') : void 0;
  }

  // @ts-expect-error internal property
  let mergedNamespace = WrappedComponent[constants_CONNECT_STATIC_NAMESPACE] || [namespace];
  ...
  return Object.assign(WrappedComponent, {
    [constants_CONNECT_STATIC_NAMESPACE]: [...new Set(mergedNamespace)],
...
function useContextSystem(props, namespace) {
  ...
  if (typeof namespace === 'undefined') {
    typeof SCRIPT_DEBUG !== "undefined" && SCRIPT_DEBUG === true ? warning('useContextSystem: Please provide a namespace') : void 0;
  }
...
function useElevation(props) {
  ...
  const classes = (0,react.useMemo)(() => {
    ...
    if (isValueDefined(hoverValue)) {
      sx.hover = /*#__PURE__*/css("*:hover>&{box-shadow:", getBoxShadow(hoverValue), ";}" + ( true ? "" : 0),  true ? "" : 0);
    }
    if (isValueDefined(activeValue)) {
      sx.active = /*#__PURE__*/css("*:active>&{box-shadow:", getBoxShadow(activeValue), ";}" + ( true ? "" : 0),  true ? "" : 0);
    }
    if (isValueDefined(focus)) {
      sx.focus = /*#__PURE__*/css("*:focus>&{box-shadow:", getBoxShadow(focus), ";}" + ( true ? "" : 0),  true ? "" : 0);
    }
...
const Card = /*#__PURE__*/css("box-shadow:0 0 0 1px ", config_values.surfaceBorderColor, ";outline:none;" + ( true ? "" : 0),  true ? "" : 0);
const Header =  true ? {
  name: "1showjb",
...
const borderRadius = /*#__PURE__*/css("&:first-of-type{border-top-left-radius:", adjustedBorderRadius, ";border-top-right-radius:", adjustedBorderRadius, ";}&:last-of-type{border-bottom-left-radius:", adjustedBorderRadius, ";border-bottom-right-radius:", adjustedBorderRadius, ";}" + ( true ? "" : 0),  true ? "" : 0);
const borderColor = /*#__PURE__*/css("border-color:", config_values.colorDivider, ";" + ( true ? "" : 0),  true ? "" : 0);
...
const rounded = /*#__PURE__*/css("border-radius:", adjustedBorderRadius, ";" + ( true ? "" : 0),  true ? "" : 0);
const xSmallCardPadding = /*#__PURE__*/css("padding:", config_values.cardPaddingXSmall, ";" + ( true ? "" : 0),  true ? "" : 0);
const cardPaddings = {
  large: /*#__PURE__*/css("padding:", config_values.cardPaddingLarge, ";" + ( true ? "" : 0),  true ? "" : 0),
  medium: /*#__PURE__*/css("padding:", config_values.cardPaddingMedium, ";" + ( true ? "" : 0),  true ? "" : 0),
  small: /*#__PURE__*/css("padding:", config_values.cardPaddingSmall, ";" + ( true ? "" : 0),  true ? "" : 0),
...
const shady = /*#__PURE__*/css("background-color:", COLORS.ui.backgroundDisabled, ";" + ( true ? "" : 0),  true ? "" : 0);
//# sourceMappingURL=styles.js.map
...
const Surface = /*#__PURE__*/css("background-color:", config_values.surfaceColor, ";color:", COLORS.gray[900], ";position:relative;" + ( true ? "" : 0),  true ? "" : 0);
const background = /*#__PURE__*/css("background-color:", config_values.surfaceBackgroundColor, ";" + ( true ? "" : 0),  true ? "" : 0);
function getBorders({
  borderBottom,
  borderLeft,
  borderRight,
...
const primary = /*#__PURE__*/css( true ? "" : 0,  true ? "" : 0);
const secondary = /*#__PURE__*/css("background:", config_values.surfaceBackgroundTintColor, ";" + ( true ? "" : 0),  true ? "" : 0);
const tertiary = /*#__PURE__*/css("background:", config_values.surfaceBackgroundTertiaryColor, ";" + ( true ? "" : 0),  true ? "" : 0);
...
const getDotted = (surfaceBackgroundSize, surfaceBackgroundSizeDotted) => /*#__PURE__*/css("background:", dottedBackgroundCombined(surfaceBackgroundSizeDotted), ";background-size:", customBackgroundSize(surfaceBackgroundSize), ";" + ( true ? "" : 0),  true ? "" : 0);
...
const getGrid = surfaceBackgroundSize => {
  return /*#__PURE__*/css("background:", config_values.surfaceBackgroundColor, ";background-image:", gridBackgroundCombined, ";background-size:", customBackgroundSize(surfaceBackgroundSize), ";" + ( true ? "" : 0),  true ? "" : 0);
};
...
function UnconnectedCard(props, forwardedRef) {
  ...
  const cx = useCx();
  const elevationClassName = (0,react.useMemo)(() => cx( /*#__PURE__*/css({
  ...
  return (0,react.createElement)(ContextSystemProvider, {
...
function useCardBody(props) {
  ...
  const cx = useCx();
  const classes = (0,react.useMemo)(() => cx(Body, borderRadius, cardPaddings[size], isShady && shady,
...
function UnconnectedCardBody(props, forwardedRef) {
  ...
  if (isScrollable) {
    return (0,react.createElement)(scrollable_component, {
      ...otherProps,
      ref: forwardedRef
    });
  }
...
function UnforwardedSpinner({
  ...
  return (0,react.createElement)(StyledSpinner, {
    ...
    ...props,
    ref: forwardedRef
  }, (0,react.createElement)(SpinnerTrack, {
    cx: "50",
    cy: "50",
    r: "50",
...
var sprintf = __webpack_require__(90);
 ...
 */
function compile_compile( expression ) {
...
function pluralForms( expression ) {
	var evaluate = compile_compile( expression );
...
function HowTo() {
  ...
  return (0,react.createElement)(react.Fragment, null, (0,react.createElement)("h1", null, "How to Create a Google Service Account"), (0,react.createElement)("p", null, "Follow this step-by-step guide to create a Google Service Account for integrating Sheet Wise with Google Sheets."), (0,react.createElement)("div", {
    className: "swise-my-5 swise-p-4 swise-border-slate-700 swise-border-l-4 swise-shadow-sm"
  }, (0,react.createElement)("h2", null, "Step 1: Open Spreadsheet Integration Settings"), (0,react.createElement)("ol", null, (0,react.createElement)("li", null, "Go to the ", (0,react.createElement)("a", {
    href: "https://cloud.google.com/",
    target: "_blank"
  }, "Google Cloud"), "."), (0,react.createElement)("li", null, "Sign in or register."), (0,react.createElement)("li", null, "Click the ", (0,react.createElement)("a", {
    href: "https://console.cloud.google.com/apis/dashboard",
    target: "_blank"
  }, "Enable API & Create a Service Account"), " link. This will open the Google API Console in a new browser tab.")), (0,react.createElement)("img", {
    className: "swise-inline-block swise-size-14 swise-rounded-md swise-w-1/2",
    src: swiseSettings.assetURL + '/img/enable-api.png',
    alt: "Enable API"
  })), (0,react.createElement)("div", {
    className: "swise-my-5 swise-p-4 swise-border-slate-700 swise-border-l-4 swise-shadow-sm"
  }, (0,react.createElement)("h2", null, "Step 2: Open the API Project Selector"), (0,react.createElement)("ol", null, (0,react.createElement)("li", null, "In the Google API Console, click the dropdown arrow at the top to open the project selector.")), (0,react.createElement)("img", {
    className: "swise-inline-block swise-size-14 swise-rounded-md swise-w-1/2",
    src: swiseSettings.assetURL + '/img/select-project.png',
    alt: "API Project Selector"
  })), (0,react.createElement)("div", {
    className: "swise-my-5 swise-p-4 swise-border-slate-700 swise-border-l-4 swise-shadow-sm"
  }, (0,react.createElement)("h2", null, "Step 3: Create a New API Project"), (0,react.createElement)("ol", null, (0,react.createElement)("li", null, "Click ", (0,react.createElement)("b", null, "New Project"), " to create a new API project."), (0,react.createElement)("li", null, "Name your project and click ", (0,react.createElement)("b", null, "Create"), ".")), (0,react.createElement)("img", {
    className: "swise-inline-block swise-size-14 swise-rounded-md swise-w-1/2",
    src: swiseSettings.assetURL + '/img/select-project.png',
    alt: "Create New Project"
  })), (0,react.createElement)("div", {
    className: "swise-my-5 swise-p-4 swise-border-slate-700 swise-border-l-4 swise-shadow-sm"
  }, (0,react.createElement)("h2", null, "Step 4: Enable Required APIs"), (0,react.createElement)("ol", null, (0,react.createElement)("li", null, "Select your newly created project from the dropdown menu."), (0,react.createElement)("li", null, "Go to the ", (0,react.createElement)("b", null, "Library"), " and search for ", (0,react.createElement)("b", null, "Google Drive API"), ". Enable it."), (0,react.createElement)("li", null, "Repeat the process to enable the ", (0,react.createElement)("b", null, "Google Sheets API"), ".")), (0,react.createElement)("img", {
    className: "swise-inline-block swise-size-14 swise-rounded-md swise-w-1/2",
    src: swiseSettings.assetURL + '/img/enable-apis.png',
    alt: "Enable APIs"
  }), (0,react.createElement)("div", {
    className: "note"
  }, "Ensure both APIs are enabled before proceeding.")), (0,react.createElement)("div", {
    className: "swise-my-5 swise-p-4 swise-border-slate-700 swise-border-l-4 swise-shadow-sm"
  }, (0,react.createElement)("h2", null, "Step 5: Create Credentials"), (0,react.createElement)("ol", null, (0,react.createElement)("li", null, "Go to the ", (0,react.createElement)("b", null, "Credentials"), " section in the API Console."), (0,react.createElement)("li", null, "Click ", (0,react.createElement)("b", null, "+ Create Credentials"), " and select ", (0,react.createElement)("b", null, "Service Account"), "."), (0,react.createElement)("li", null, "Name the service account (e.g., Spreadsheet Integration Service Account)."), (0,react.createElement)("li", null, "Click ", (0,react.createElement)("b", null, "Done"), " to create the account.")), (0,react.createElement)("img", {
    className: "swise-inline-block swise-size-14 swise-rounded-md swise-w-1/2",
    ...
    className: "swise-my-5 swise-p-4 swise-border-slate-700 swise-border-l-4 swise-shadow-sm"
  }, (0,react.createElement)("h2", null, "Step 6: Generate a Service Account Key"), (0,react.createElement)("ol", null, (0,react.createElement)("li", null, "Click on the created service account email address."), (0,react.createElement)("li", null, "Go to the ", (0,react.createElement)("b", null, "Keys"), " tab and select ", (0,react.createElement)("b", null, "Add Key > Create New Key"), "."), (0,react.createElement)("li", null, "Choose ", (0,react.createElement)("b", null, "JSON"), " as the key type and click ", (0,react.createElement)("b", null, "Create"), "."), (0,react.createElement)("li", null, "Download the JSON file to your computer.")), (0,react.createElement)("div", {
    className: "note"
  }, "Keep this file safe as it contains sensitive information.")), (0,react.createElement)("div", {
    className: "swise-my-5 swise-p-4 swise-border-slate-700 swise-border-l-4 swise-shadow-sm"
  }, (0,react.createElement)("h2", null, "Step 7: Configure in WordPress"), (0,react.createElement)("ol", null, (0,react.createElement)("li", null, "Go back to the ", (0,react.createElement)("b", null, "Sheet Wise > Settings"), " from WP Dashboard."), (0,react.createElement)("li", null, "Paste the contents of the downloaded JSON file in the key field."), (0,react.createElement)("li", null, "Click ", (0,react.createElement)("b", null, "Save"), "."))), (0,react.createElement)("div", {
    className: "swise-my-5 swise-p-4 swise-border-slate-700 swise-border-l-4 swise-shadow-sm"
  }, (0,react.createElement)("h2", null, "Step 8: Share Google Sheets with Service Account"), (0,react.createElement)("ol", null, (0,react.createElement)("li", null, "Go to your Google Sheet and click the ", (0,react.createElement)("b", null, "Share"), " button."), (0,react.createElement)("li", null, "Enter the service account email address and click ", (0,react.createElement)("b", null, "Done"), "."))));
}
...
function Settings() {
  ...
  var _useState3 = (0,react.useState)(''),
    ...
    credentialJson = _useState4[0],
    setCredentialJson = _useState4[1];
    ...
    var _ref = _asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee() {
      ...
      return regenerator_default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 5:
            cred = JSON.parse(credentialJson.trim());
          ...
          case 9:
            _context.next = 11;
            return fetch(swiseSettings.restURL + '/settings', {
              method: 'PATCH',
              headers: {
                'Content-Type': 'application/json',
                'X-WP-Nonce': swiseSettings.nonce
  ...
  var SettingsOptions = function SettingsOptions() {
    return (0,react.createElement)(react.Fragment, null, (0,react.createElement)("div", {
      ...
      stopColor: "white",
      stopOpacity: "0"
    })))), "\xA0\xA0 ", __('Google Sheet', 'swise'))))), (0,react.createElement)(card_component, null, (0,react.createElement)(card_body_component, null, (0,react.createElement)("div", null, (0,react.createElement)("label", {
    ...
    }, __('Service Account Credential JSON', 'swise')), (0,react.createElement)("textarea", {
      id: "swise-credential",
    ...
    }, __('Copy the full JSON file Credentials and paste it here. ', 'swise'), (0,react.createElement)("a", {
      href: swiseSettings.pageURL + '#/how-to',
      className: "swise-font-medium swise-text-blue-600 hover:swise-underline dark:swise-text-blue-500 focus:swise-shadow-none"
    }, __('How to?', 'swise'))), errors.credential && (0,react.createElement)("p", {
      className: "swise-mt-2 swise-text-sm swise-text-red-600 dark:swise-text-red-500"
    }, errors.credential.message)), (0,react.createElement)("button", {
      type: "button",
  ...
  return (0,react.createElement)(react.Fragment, null, (0,react.createElement)(Header_Header, {
    ...
    path: routes_settings.home,
    element: (0,react.createElement)(SettingsOptions, null)
  }), (0,react.createElement)(Route, {
    path: routes_settings.docs.howto,
    element: (0,react.createElement)(HowTo, null)
  }))));
}
;// ./src/js/settings.js
...
client.createRoot(document.getElementById('swise-settings')).render((0,react.createElement)(react.StrictMode, null, (0,react.createElement)(Settings, null)));
})();
