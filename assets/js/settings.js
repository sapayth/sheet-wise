...
var emotion_element_5486c51c_browser_esm_Insertion = function Insertion(_ref) {
  var cache = _ref.cache,
...
function (props, cache, ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(emotion_element_5486c51c_browser_esm_Insertion, {
    cache: cache,
...
var node_modules_classnames = __webpack_require__(942);
...
const UnconnectedBaseControl = props => {
  ...
  return (0,react.createElement)(Wrapper, {
    ...
    as: "label"
  }, label) : (0,react.createElement)(VisualLabel, null, label)), children), !!help && (0,react.createElement)(StyledHelp, {
...
var sprintf = __webpack_require__(604);
...
function Header(_ref) {
  ...
  return (0,react.createElement)("div", {
    className: "swise-nav-toolbar swise-bg-slate-700 swise-text-slate-100 swise-flex swise-justify-between swise--ml-[20px]"
  ...
  }, version))), (0,react.createElement)("div", {
    className: "swise-m-6"
  }, (0,react.createElement)("span", {
    className: "swise-font-medium swise-text-lg"
  }, __('Got an feature idea? ', 'sheet-wise')), (0,react.createElement)("a", {
    href: "https://sheetwise.canny.io/feature-requests",
    target: "_blank",
...
/* harmony default export */ const routes_settings = (settingsRoute);
...
function Settings() {
  ...
  var Field = function Field(_ref2) {
    ...
    var fieldKey = field.id;
    var fieldType = field.field_type;
    var fieldLabel = field.label;
    var placeholder = field.placeholder;
    var _useState7 = (0,react.useState)(settings[sectionKey][fieldKey]),
      _useState8 = _slicedToArray(_useState7, 2),
      value = _useState8[0],
      setValue = _useState8[1];
    switch (fieldType) {
      case 'textarea':
        return (0,react.createElement)("textarea", {
          id: fieldKey,
      ...
      case 'toggle':
        return (0,react.createElement)(toggle_control, {
          checked: value,
      ...
      default:
        return (0,react.createElement)("input", {
          type: "text",
          id: fieldKey,
          placeholder: "Enter ".concat(fieldLabel),
          value: value,
          onChange: function onChange(e) {
            setValue(e.target.value);
            settings[sectionKey][fieldKey] = e.target.value;
  ...
  var TabContentForm = function TabContentForm(_ref3) {
    ...
    return (0,react.createElement)("div", {
      className: "swise-bg-white swise-p-6 swise-rounded-lg swise-shadow"
    }, (0,react.createElement)("div", {
      className: "swise-mb-8"
    }, (0,react.createElement)("h2", {
      className: "swise-text-xl swise-font-semibold swise-m-0"
    }, title), (0,react.createElement)("p", {
      className: "swise-text-sm swise-text-gray-500 swise-my-4"
    }, description)), fields.map(function (field, index) {
      return (0,react.createElement)("div", {
        key: index,
        className: "swise-mb-6"
      }, (0,react.createElement)("label", {
        className: "swise-block swise-text-sm swise-font-medium swise-text-gray-700",
        htmlFor: field.id
      }, field.label), (0,react.createElement)(Field, {
        key: field.id,
        field: field,
        sectionKey: tabKey
      }), field.description && (0,react.createElement)("p", {
  ...
  var Settings = function Settings() {
    ...
    var tabsData = swiseSettings.settings;
    var _useState9 = (0,react.useState)(Object.keys(tabsData)[0]),
      _useState10 = _slicedToArray(_useState9, 2),
      activeTab = _useState10[0],
      setActiveTab = _useState10[1];
    return (0,react.createElement)("div", null, (0,react.createElement)("div", {
      className: "swise-flex swise-border-b swise-border-gray-300 swise-mb-4"
    }, Object.keys(tabsData).map(function (tabKey) {
      return (0,react.createElement)("button", {
        key: tabKey,
        onClick: function onClick() {
          return setActiveTab(tabKey);
        },
        className: "swise-p-4 swise-text-base ".concat(activeTab === tabKey ? "swise-border-b-2 swise-border-black swise-text-black" : "swise-text-gray-500")
      }, tabsData[tabKey].label);
    })), Object.keys(tabsData).map(function (tabKey) {
      return activeTab === tabKey && (0,react.createElement)(TabContentForm, {
        key: tabKey,
        tabKey: tabKey,
        title: tabsData[tabKey].label,
        description: tabsData[tabKey].description,
        fields: Object.entries(tabsData[activeTab].fields).map(function (_ref4) {
  ...
  return (0,react.createElement)(react.Fragment, null, (0,react.createElement)(Header, {
    ...
    element: (0,react.createElement)(Settings, null)
